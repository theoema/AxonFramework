...
public class TenantDescriptor {
    ...
    public TenantDescriptor(String tenantId, Map<String, String> properties) {
        this.tenantId = Objects.requireNonNull(tenantId, "tenantId may not be null");
        this.properties = properties != null ? Collections.unmodifiableMap(Map.copyOf(properties)) : Collections.emptyMap();
    }
