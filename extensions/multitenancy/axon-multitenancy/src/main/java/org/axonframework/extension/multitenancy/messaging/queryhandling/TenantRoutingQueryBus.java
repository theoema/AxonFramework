 ...
 * <p>
 * The {@code TenantRoutingQueryBus} relies on a {@link TenantResolver} to dispatch queries via resolved tenant
 ...
 * @since 4.6.0
 */
public class TenantRoutingQueryBus implements QueryBus, MultiTenantAwareComponent {

    /**
     * The order in which the {@link TenantRoutingQueryBus} is applied as a decorator to the {@link QueryBus}.
     */
    ...
    /**
     * Instantiate a {@link TenantRoutingQueryBus} with the given {@code tenantSegmentFactory} and
     * {@code tenantResolver}.
     *
     ...
     */
    public TenantRoutingQueryBus(TenantQuerySegmentFactory tenantSegmentFactory,
    ...
    private QueryBus resolveTenantFromContext(@Nullable ProcessingContext context) {
        ...
        TenantDescriptor tenantDescriptor = TenantResolver.fromContext(context, tenantResolver, tenantSegments.keySet());
    ...
    /**
     * Returns the tenant segments managed by this {@code TenantRoutingQueryBus}.
     *
