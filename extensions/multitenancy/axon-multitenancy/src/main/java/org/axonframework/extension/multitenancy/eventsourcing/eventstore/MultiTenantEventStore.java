...
public class MultiTenantEventStore implements EventStore, MultiTenantAwareComponent {
    ...
    /**
     * Instantiate a {@link MultiTenantEventStore} with the given {@code tenantSegmentFactory} and
     ...
     */
    public MultiTenantEventStore(TenantEventSegmentFactory tenantSegmentFactory,
    ...
    public CompletableFuture<Void> publish(@Nullable ProcessingContext context,
        ...
        if (resolveFrom == null && !events.isEmpty()) {
    ...
    public EventStoreTransaction transaction(ProcessingContext processingContext) {
        ...
        if (message == null) {
            throw new IllegalStateException(
                    ...
                    + "Ensure commands are dispatched through MultiTenantCommandBus and that the message "
                    + "is available in the processing context for tenant resolution."
            );
        }
