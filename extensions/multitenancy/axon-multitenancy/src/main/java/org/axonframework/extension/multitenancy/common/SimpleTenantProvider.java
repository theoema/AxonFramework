 ...
 * messagingConfigurer.componentRegistry(cr -> {
 *     cr.registerComponent(TenantProvider.class, config -> provider);
 *     cr.registerComponent(TenantResolver.class, config -> myResolver);
 * });
 * }</pre>
 * <p>
...
public class SimpleTenantProvider implements TenantProvider {
     ...
     */
    public SimpleTenantProvider(Collection<TenantDescriptor> initialTenants) {
     ...
     */
    public boolean addTenant(TenantDescriptor tenant) {
     ...
     */
    public void addTenants(Collection<TenantDescriptor> tenantsToAdd) {
     ...
     */
    public boolean removeTenant(TenantDescriptor tenant) {
        requireNonNull(tenant, "Tenant cannot be null");
     ...
     */
    public boolean hasTenant(TenantDescriptor tenant) {
        requireNonNull(tenant, "Tenant cannot be null");
