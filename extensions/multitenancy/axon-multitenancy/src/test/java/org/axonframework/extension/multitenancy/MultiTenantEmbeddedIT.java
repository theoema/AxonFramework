...
class MultiTenantEmbeddedIT {
    ...
    void setUp() {
        ...
        configurer.componentRegistry(cr -> {
            ...
            cr.registerComponent(TargetTenantResolver.class, config -> new MetadataBasedTenantResolver());
    ...
    class Snapshotting {
        ...
        void snapshotStoreIsMultiTenantWithCorrectSegments() {
            ...
            // then
            assertThat(snapshotStore).isInstanceOf(MultiTenantSnapshotStore.class);
            MultiTenantSnapshotStore multiTenantStore = (MultiTenantSnapshotStore) snapshotStore;
        ...
        void snapshotCreatedAfterEventSourcingOnCorrectTenant() {
            ...
            MultiTenantSnapshotStore multiTenantStore =
                    (MultiTenantSnapshotStore) configuration.getComponent(SnapshotStore.class);
