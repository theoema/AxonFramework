...
* Multi-tenant infrastructure with per-tenant isolation of buses, stores, and event processors (via the xref:modules.adoc#axon-multitenancy[Multi-Tenancy extension])
