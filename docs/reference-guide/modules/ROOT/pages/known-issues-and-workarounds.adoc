...
Especially when combining this with Axon's xref:multitenancy-guide::index.adoc[multitenancy] extension, the new default behavior of Hibernate 6 might cause uniqueness issues in this way.
